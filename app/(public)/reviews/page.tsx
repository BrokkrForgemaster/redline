    ...
    <>
      <section className="bg-offwhite py-16 px-6">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-charcoal">Customer Reviews</h1>
      ...
      <section className="bg-white py-24 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {reviews.map((review) => (
            <div key={review.name} className="bg-white border border-border rounded-lg p-8 shadow-sm hover:shadow-md transition-shadow">
              <StarRating />
              ...
              <div className="mt-6 border-t border-border pt-4">
                ...
                <p className="text-sm text-muted">{review.location} &middot; {review.service}</p>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="bg-offwhite py-16 px-6">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-charcoal">Ready to See for Yourself?</h2>
          ...
          <Link href="/contact" className="inline-block mt-8 bg-redline text-white text-sm font-semibold uppercase tracking-wide px-8 py-3 rounded-md hover:bg-red-800 transition-colors">
            Request a Quote
          </Link>
        </div>
      </section>
